...
const useLocation = () => {
    const { location, locationWithText,countryData, selectedSchool } = useSelector((state: RootState) => state.location);
    ...
    return { location,locationWithText,pickCurrentLocation ,countryData, selectedSchool};
};
