...
const CountrySelector = memo(() => {
    ...
    return (
        <View>
            ...
            }} style={{padding:20,borderRadius:10,flexDirection:'row',borderColor:'#a8a6a5',borderWidth:1}}>
                <SvgUri
                    width={20}
                    height={18}
                    uri={countryData?.flag}
                />
                <Text style={{flex:1,marginLeft:10,fontFamily:'fontBold'}}>{countryData?.dialCode}</Text>
